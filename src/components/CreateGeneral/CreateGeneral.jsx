...
// try: increment this value on hitting add repertoire -> render the number of components accordingly
const [repertoireNumber, setRepertoireNumber] = useState(1)
  ...
  return (
    <Container component = 'form' onSubmit = {handleSubmit} sx = {{display: 'flex', flexDirection: 'column'}}>
      ...
      <Button
            ...
            onClick = {()=>setRepertoireNumber(repertoireNumber+1)}
          >add repertoire</Button>

      <Button sx = {{textAlign: 'right'}} type = 'submit'>create schedule</Button>
      <RepertoireContainer number={repertoireNumber}/>
    </Container>
  )
}